...
namespace Empleados.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "puesto,descripcion")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "puesto,descripcion")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
